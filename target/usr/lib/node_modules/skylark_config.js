(function (fs, net, x2js, child_process, onddclient, telemetry, crypto) {
  ...
  module.exports.setNetConf = function(args, callback) {
    ...
    if(args.sta && args.sta.ssid && args.sta.password) {
        args.sta.password = crypto.pbkdf2Sync(args.sta.password,args.sta.ssid,4096,32,'sha1').toString("hex")
    }

    if (OuternetPassword) {
        run_cmd("/usr/bin/changepass.sh",[ "outernet", OuternetPassword] , function() {
